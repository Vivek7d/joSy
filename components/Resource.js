            ...
            <CardContent>
              <ul className="space-y-4">
                ...
                <li className="flex items-start space-x-4">
                  <Badge className="mt-1">New</Badge>
                  <div>
                    <h4 className="font-semibold">Networking Strategies for Career Growth</h4>
                    <p className="text-sm text-gray-600">Explore new strategies and tools to expand your professional network and unlock new opportunities.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4">
                  <Badge variant="outline" className="mt-1">New</Badge>
                  <div>
                    <h4 className="font-semibold">Guide to Personal Branding</h4>
                    <p className="text-sm text-gray-600">Updated guide on building and maintaining a strong personal brand in the digital age.</p>
                  </div>
                </li>
                <li className="flex items-start space-x-4">
                  <Badge className="mt-1">New</Badge>
                  <div>
                    <h4 className="font-semibold">Virtual Job Fair: What to Expect</h4>
                    <p className="text-sm text-gray-600">A comprehensive guide on how to prepare for and make the most of virtual job fairs.</p>
                  </div>
                </li>
              </ul>
            </CardContent>
